...
{                                                                                           \
    struct nxp_spi *nxp_spi;                                                                \
    os_list_for_each_entry(nxp_spi, &nxp_spi_list, struct nxp_spi, list)                    \
    {                                                                                       \
        if (nxp_spi->spi_info->spi_base == (SPI_Type *)FLEXCOMM##__index)                   \
        {                                                                                   \
            break;                                                                          \
        }                                                                                   \
    }                                                                                       \
...
#define SPI_NBK_INIT(_NXP_SPI_, __index)                                                    \
        ...
        _NXP_SPI_->spi_handle->callback = nxp_spi_transfer_callback;                        \
...
#define SPI_DMA_INIT(_NXP_SPI_, __index)                                                    \
        ...
        _NXP_SPI_->spi_DmaHandle->callback = nxp_spi_dma_callback;                           \
