...
{                                                                                           \
    ...
    os_list_for_each_entry(nxp_i2c, &nxp_i2c_list, struct nxp_i2c, list)                    \
    {                                                                                       \
        if (nxp_i2c->i2c_info->i2c_base == (I2C_Type *)FLEXCOMM##__index)                   \
        {                                                                                   \
            break;                                                                          \
        }                                                                                   \
    }                                                                                       \
...
#define I2C_NBK_INIT(_NXP_I2C_, __index)                                                    \
        ...
        _NXP_I2C_->i2c_handle->callback = nxp_i2c_transfer_callback;                        \
...
#define I2C_DMA_INIT(_NXP_I2C_, __index)                                                    \
        ...
        _NXP_I2C_->i2cDmaHandle->callback = nxp_i2c_dma_callback;                           \
