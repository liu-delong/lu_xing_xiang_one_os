...
** History:
**
**   - 2018-05-18  0.1   First version for Device Driver Library of Module.
**
******************************************************************************/
...
typedef struct
{
    ...
    __IO uint32_t TIM3                      : 1;
} stc_debug_active_debug_active_field_t;
...
typedef struct
{
    union
    {
        ...
        stc_debug_active_debug_active_field_t DEBUG_ACTIVE_f;
    };
