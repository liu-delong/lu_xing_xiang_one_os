...
en_result_t I2C_MasterWriteData(en_i2c_channel_t enCh,uint8_t u8Addr,uint8_t *pu8Data,uint32_t u32Len)
{
    ...
    I2C_WriteByte(enCh,I2c_SlaveWt);//从机地址发送OK
    I2C_ClearIrq(enCh);
 ...
 **
 ******************************************************************************/
 en_result_t I2C_MasterReadData(en_i2c_channel_t enCh,uint8_t *pu8Data,uint8_t u8Addr,uint32_t u32Len)
{
    en_result_t enRet = Error;
    uint8_t u8i,u8State;
    ...
    I2C_ClearFunc(enCh,I2cStart_En);
#endif
    I2C_WriteByte(enCh,I2c_SlaveRd);//从机地址发送OK
    I2C_ClearIrq(enCh);
