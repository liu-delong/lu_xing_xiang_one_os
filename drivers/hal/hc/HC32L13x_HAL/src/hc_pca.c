 ...
 ******************************************************************************/
//d/static func_ptr_t pfnPcaCallback = NULL;
 ...
 **
 **
 ** \param [in]  pstcConfig           PCA模块配置结构体指�?
 **  
 ** \retval Ok or Error
 *****************************************************************************/
 ...
 **
 ** \param [in]  enModule            PCA模块选择（Module0、Module1、Module2、Module3、Module4�?
 ** \param [in]  pstcCapMod          PCA模式配置结构体指�?
 **  
 ** \retval Ok or Error
 *****************************************************************************/
