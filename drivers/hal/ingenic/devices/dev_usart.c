...
struct ingenic_usart_info usart0_info = {.hw_base=UART0_BASE,.irqno=IRQ_UART0};
OS_HAL_DEVICE_DEFINE("UART_HandleTypeDef", "uart0", usart0_info);
#endif

#ifdef BSP_USING_USART1
struct ingenic_usart_info usart1_info = {.hw_base=UART1_BASE,.irqno=IRQ_UART1};
OS_HAL_DEVICE_DEFINE("UART_HandleTypeDef", "uart1", usart1_info);
#endif  

#ifdef BSP_USING_USART2
struct ingenic_usart_info usart2_info = {.hw_base=UART2_BASE,.irqno=IRQ_UART2};
