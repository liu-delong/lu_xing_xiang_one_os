...
{
    {GET_PIN(D, 4), PIN_HIGH},
    {GET_PIN(D, 5), PIN_HIGH},
    {GET_PIN(G, 3), PIN_HIGH},
};
...
{
    {GET_PIN(A, 0),    PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_FALLING},
    {GET_PIN(C, 13),    PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_FALLING},
    {GET_PIN(B, 14),    PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_FALLING},
};
