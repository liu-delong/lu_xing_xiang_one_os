...
if COMPILER == 'gcc':
    ...
    CFLAGS = '-c ' + DEVICE + ' --apcs=interwork --split_sections --c99 --library_interface=armcc --library_type=standardlib --diag_suppress=66,1296,186 '
    AFLAGS = DEVICE + ' --apcs=interwork '
    LFLAGS = DEVICE + ' --scatter "board\linker_scripts\link.sct" --info sizes --info totals --info unused --info veneers --list oneos.map --strict --diag_suppress 6314'
