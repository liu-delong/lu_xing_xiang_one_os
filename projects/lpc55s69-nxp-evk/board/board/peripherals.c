...
dma_handle_t USART0_RX_Handle;
dma_handle_t USART0_TX_Handle;
usart_dma_handle_t USART0_USART_DMA_Handle;
...
static void USART0_init(void) {
  ...
  DMA_EnableChannel(USART0_RX_DMA_BASEADDR, USART0_RX_DMA_CHANNEL);
  /* Create the DMA USART0_RX_Handlehandle */
  DMA_CreateHandle(&USART0_RX_Handle, USART0_RX_DMA_BASEADDR, USART0_RX_DMA_CHANNEL);
  /* Enable the DMA 5channel in the DMA */
  DMA_EnableChannel(USART0_TX_DMA_BASEADDR, USART0_TX_DMA_CHANNEL);
  /* Create the DMA USART0_TX_Handlehandle */
  DMA_CreateHandle(&USART0_TX_Handle, USART0_TX_DMA_BASEADDR, USART0_TX_DMA_CHANNEL);
  /* Create the USART DMA handle */
  USART_TransferCreateHandleDMA(USART0_PERIPHERAL, &USART0_USART_DMA_Handle, NULL, NULL, &USART0_TX_Handle, &USART0_RX_Handle);
}
