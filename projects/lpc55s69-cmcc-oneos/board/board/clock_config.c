...
- {id: CTIMER3_clock.outFreq, value: 96 MHz}
- {id: CTIMER4_clock.outFreq, value: 96 MHz}
- {id: FXCOM0_clock.outFreq, value: 12 MHz, locked: true, accuracy: '0.001'}
- {id: FXCOM1_clock.outFreq, value: 12 MHz, locked: true, accuracy: '0.001'}
- {id: FXCOM2_clock.outFreq, value: 12 MHz, locked: true, accuracy: '0.001'}
...
- {id: FXCOM7_clock.outFreq, value: 512/11 MHz}
- {id: HSLSPI_clock.outFreq, value: 48 MHz}
- {id: MCLK_clock.outFreq, value: 24 MHz}
- {id: System_clock.outFreq, value: 96 MHz}
- {id: USB0_clock.outFreq, value: 48 MHz}
- {id: UTICK_clock.outFreq, value: 1 MHz}
- {id: WDT_clock.outFreq, value: 31.25/2 kHz}
settings:
...
- {id: SYSCON.CTIMERCLKSEL3.sel, value: ANACTRL.fro_hf_clk}
...
- {id: SYSCON.FRGCTRL7_DIV.scale, value: '264', locked: true}
...
- {id: SYSCON.MCLKCLKSEL.sel, value: ANACTRL.fro_hf_clk}
- {id: SYSCON.MCLKDIV.scale, value: '4', locked: true}
...
- {id: SYSCON.WDTCLKDIV.scale, value: '64', locked: true}
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFlexFrg7, 2304U, false);         /*!< Set FRGCTRL7_DIV divider to value 264 */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivWdtClk, 64U, false);         /*!< Set WDTCLKDIV divider to value 64 */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivMClk, 4U, false);         /*!< Set MCLKDIV divider to value 4 */
