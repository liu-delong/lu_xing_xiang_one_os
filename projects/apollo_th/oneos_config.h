...
#define SOC_FAMILY_APOLLO
#define SOC_SERIES_APOLLO
#define SOC_APOLLO_XXX
...
#define BSP_SOFT_I2C1_SCL_PIN 5
#define BSP_SOFT_I2C1_SDA_PIN 6
/* end of I2C */
