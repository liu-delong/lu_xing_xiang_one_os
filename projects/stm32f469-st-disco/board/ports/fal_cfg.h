...
#define OS_DL_PART_SIZE     (4 * 128 * 1024)
...
#define OS_RAM_PART_SIZE     (512 * 1024)
...
{                                                                                                                              \
    ...
    {OS_RAM_PART_NAME, OS_RAM_FLASH_NAME,    (0),                                     OS_RAM_PART_SIZE, 0}, \
}
