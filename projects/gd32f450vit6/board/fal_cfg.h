...
#define OS_TEST_PART_NAME "test_part"
#define OS_TEST_FLASH_NAME "onchip_flash"

#define OS_TEST_PART_ADDR     ((uint32_t)0x08040000)
#define OS_TEST_PART_SIZE     (128*1024)
...
#define OS_APP_PART_SIZE     (11 * 128 * 1024)
...
#define OS_DL_PART_SIZE     (3 * 128 * 1024)
...
#define OS_FF_PART_SIZE     (64 * 1024)
