 ...
 */
#define SENSOR_POWER_PIN     GET_PIN(D, 14)
#define AUDIO_POWER_PIN      GET_PIN(D, 15)
#define WIFI_POWER_PIN       GET_PIN(C, 6)

/* CAN RS PIN Active Low */ 
#define CAN_RS_PIN           GET_PIN(D, 2)
