...
#define OS_EE_PART_NAME "eeprom"     /* eeprom */

/* Flash device Configuration */
#define OS_ONCHIP_FLASH_NAME "onchip_flash"
#define OS_EXTERN_FLASH_NAME "nor_flash"
#define OS_EEPRPM_NAME       "at24cxx_eeprom"
#define OS_NAND_NAME         "nand1"

#define MCU_SRAM_BEGIN ((os_uint32_t)0x20000000)
#define MCU_SRAM_SIZE  ((128 - 32) * 1024)
#define MCU_SRAM_END   (MCU_SRAM_BEGIN + MCU_SRAM_SIZE)

#define MCU_ROM_BEGIN ((os_uint32_t)0x08000000)
#define MCU_ROM_SIZE  (512 * 1024)
#define MCU_ROM_END   (MCU_ROM_BEGIN + MCU_ROM_SIZE)

#define MCU_SPI_FLASH_BEGIN ((os_uint32_t)0x00)
#define MCU_SPI_FLASH_SIZE  (16 * 1024 * 1024)
...
/* cfg */
#define MCU_CFG_ENTRY ((os_uint32_t)MCU_BOOT_END)
#define MCU_CFG_SIZE  (64 * 1024)
#define MCU_CFG_END   (MCU_CFG_ENTRY + MCU_CFG_SIZE)

/* app */
#define OS_APP_PART_ADDR     ((os_uint32_t)MCU_CFG_END)
#define OS_APP_PART_SIZE     (8 * 128 * 1024)
#define OS_APP_PART_END_ADDR (OS_APP_PART_ADDR + OS_APP_PART_SIZE)

#define USER_APP_ENTRY OS_APP_PART_ADDR

/* download */
#define OS_DL_PART_ADDR     ((os_uint32_t)OS_APP_PART_END_ADDR)
#define OS_DL_PART_SIZE     (7 * 128 * 1024)
#define OS_DL_PART_END_ADDR (OS_DL_PART_ADDR + OS_DL_PART_SIZE)

/* diff_patch */
#define OS_DF_PART_ADDR     ((os_uint32_t)MCU_SPI_FLASH_BEGIN)
#define OS_DF_PART_SIZE     (1024 * 1024)
#define OS_DF_PART_END_ADDR (OS_DF_PART_ADDR + OS_DF_PART_SIZE)

/* BK: backup */
#define OS_BK_PART_ADDR     ((os_uint32_t)OS_DF_PART_END_ADDR)
#define OS_BK_PART_SIZE     (1024 * 1024)
#define OS_BK_PART_END_ADDR (OS_BK_PART_ADDR + OS_BK_PART_SIZE)

/* ef: easyflash */
#define OS_EF_PART_ADDR     ((os_uint32_t)OS_BK_PART_END_ADDR)
#define OS_EF_PART_SIZE     (512 * 1024)
#define OS_EF_PART_END_ADDR (OS_EF_PART_ADDR + OS_EF_PART_SIZE)

/* wf: wifi image */
#define OS_RF_PART_ADDR     ((os_uint32_t)OS_EF_PART_END_ADDR)
#define OS_RF_PART_SIZE     (512 * 1024)
#define OS_RF_PART_END_ADDR (OS_RF_PART_ADDR + OS_RF_PART_SIZE)

/* ff: font */
#define OS_FF_PART_ADDR     ((os_uint32_t)OS_RF_PART_END_ADDR)
#define OS_FF_PART_SIZE     (7 * 1024 * 1024)
#define OS_FF_PART_END_ADDR (OS_FF_PART_ADDR + OS_FF_PART_SIZE)

/* fs: filesystem */
#define OS_FS_PART_ADDR     ((os_uint32_t)OS_FF_PART_END_ADDR)
#define OS_FS_PART_SIZE     (6 * 1024 * 1024)
...
{                                                                                                                              \
    ...
    {OS_EE_PART_NAME,   OS_EEPRPM_NAME,                                           (0),               256, FAL_PART_INFO_FLAGS_LOCK}, \
    {"nand_part1",      OS_NAND_NAME,                                             (0), 128 * 1024 * 1024, FAL_PART_INFO_FLAGS_LOCK}, \
    {"nand_part2",      OS_NAND_NAME,                             (128 * 1024 * 1024), 6 * 1024 * 1024, 0}, \
    {"nand_part3",      OS_NAND_NAME,                             (256 * 1024 * 1024), 128 * 1024 * 1024, 0}, \
    {"nand_part4",      OS_NAND_NAME,                             (384 * 1024 * 1024), 128 * 1024 * 1024, 0}, \
}
