 ...
 *
 * @file        posix_termios.c
 *
 * @brief       The termios functions describe a general terminal interface that is provided to control asynchronous 
...
/* This function gets process group ID for session leader for controlling terminal */
