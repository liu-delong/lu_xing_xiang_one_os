...
QDEF(MP_QSTR_Event_creat, (const byte*)"\x17\x0b" "Event_creat")
QDEF(MP_QSTR_send_event, (const byte*)"\x2a\x0a" "send_event")
QDEF(MP_QSTR_recv_event, (const byte*)"\xf4\x0a" "recv_event")
QDEF(MP_QSTR_Event_delete, (const byte*)"\xcf\x0c" "Event_delete")
...
QDEF(MP_QSTR_Lightsensor, (const byte*)"\xcd\x0b" "Lightsensor")
