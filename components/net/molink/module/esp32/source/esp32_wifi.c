...
os_err_t esp32_wifi_scan_info(mo_object_t *module, char *ssid, mo_wifi_scan_result_t *scan_result)
{
    ...
    at_resp_t resp = {.buff      = calloc(1, ESP32_SCAN_RESP_BUFF_LEN),
