...
#define DBG_EXT_TAG "esp8266.netconn"
#define DBG_EXT_LVL DBG_EXT_INFO
#include <os_dbg_ext.h>

#define SEND_DATA_MAX_SIZE (2048)

#ifndef ESP8266_DATA_QUEUE_SIZE
#define ESP8266_DATA_QUEUE_SIZE (5)
#endif
...
mo_netconn_t *esp8266_netconn_create(mo_object_t *module, mo_netconn_type_t type)
{
    ...
    os_data_queue_init(&netconn->data_queue, ESP8266_DATA_QUEUE_SIZE, 0, OS_NULL);
