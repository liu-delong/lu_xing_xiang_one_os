...
void rb_ring_buff_init(rb_ring_buff_t *rb, os_uint8_t *pool, os_uint32_t pool_size)
{
    ...
    rb->buff         = pool;
    rb->buff_size    = OS_ALIGN_DOWN(pool_size, OS_ALIGN_SIZE);

    return;
}
EXPORT_SYMBOL(rb_ring_buff_init);
...
EXPORT_SYMBOL(rb_ring_buff_reset);
...
EXPORT_SYMBOL(rb_ring_buff_create);
...
EXPORT_SYMBOL(rb_ring_buff_destroy);
#endif /* OS_USING_HEAP */
...
EXPORT_SYMBOL(rb_ring_buff_data_len);
...
EXPORT_SYMBOL(rb_ring_buff_space_len);
...
EXPORT_SYMBOL(rb_ring_buff_put);
...
EXPORT_SYMBOL(rb_ring_buff_put_force);
...
EXPORT_SYMBOL(rb_ring_buff_get);
...
EXPORT_SYMBOL(rb_ring_buff_put_char);
...
EXPORT_SYMBOL(rb_ring_buff_put_char_force);
...
EXPORT_SYMBOL(rb_ring_buff_get_char);
